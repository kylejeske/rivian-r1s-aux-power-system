...
- [x] [`system-architecture.mmd`](system-architecture.mmd) - full system block diagram.
- [x] [`battery-module-wiring.mmd`](battery-module-wiring.mmd) - per-module electrical schematic.
- [x] [`dock-controller-wiring.mmd`](dock-controller-wiring.mmd) - dock/controller wiring architecture.
- [x] Busbar topology is represented in [`dock-controller-wiring.mmd`](dock-controller-wiring.mmd).
- [x] [`module-physical-layout.mmd`](module-physical-layout.mmd) - battery sled physical layout.
- [x] [`dock-physical-layout.mmd`](dock-physical-layout.mmd) - dock physical layout.
- [x] [`service-sequence.mmd`](service-sequence.mmd) - safe install/remove/charge service sequence.
